...
class Routes {
  ...
  static const championView = '/champion-view';
...
class ChampionViewArguments {
  ...
  @override
  String toString() {
    return '{"key": "$key", "championName": "$championName"}';
  }

  @override
  bool operator ==(covariant ChampionViewArguments other) {
    if (identical(this, other)) return true;
    return other.key == key && other.championName == championName;
  }

  @override
  int get hashCode {
    return key.hashCode ^ championName.hashCode;
  }
}
